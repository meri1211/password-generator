...
let bigArray = [];
let userPassword = userPasswordOptions
...
function getPasswordOptions() {
  ...
  // Created confirm pop ups to confirm if the user would like to have  different types of characters, lowercase, etc or not, and stored the    answers in variables.
   let hasSpecialChar = confirm("Would you like your password to include special characters?");
   console.log(hasSpecialChar);

   let hasNumbers = confirm("Would you like your password to include numbers?");
   console.log(hasNumbers);

   let hasLowerCase = confirm("Would you like your password to have lowercase letters?");
   console.log(hasLowerCase);
 
   let hasUpperCase = confirm("Would you like your password to have uppercase letters?");
   console.log(hasUpperCase);
   // Created an alert in case no character types are chosen.
   if (hasSpecialChar === false && hasNumbers === false
